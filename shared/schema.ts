...
export const insertAuctionSchema = z.object({
  ...
  apvNumberOfTrees: z.number().nullable().optional(),
  apvAverageHeight: z.number().nullable().optional(),
  apvAverageDiameter: z.number().nullable().optional(),
  apvNetVolume: z.number().nullable().optional(),
  apvGrossVolume: z.number().nullable().optional(),
  apvSurfaceHa: z.number().nullable().optional(),
  apvFirewoodVolume: z.number().nullable().optional(),
  apvBarkVolume: z.number().nullable().optional(),
  ...
  apvHarvestYear: z.number().nullable().optional(),
  apvInventoryMethod: z.string().optional(),
  apvHammerMark: z.string().optional(),
  apvAccessibility: z.string().optional(),
  apvAverageAge: z.number().nullable().optional(),
  apvSlopePercent: z.number().nullable().optional(),
  apvDendrometryPerSpecies: z.record(z.object({
    dt_cm: z.number().nullable().optional(),
    dcg_cm: z.number().nullable().optional(),
    ht_m: z.number().nullable().optional(),
    hc_m: z.number().nullable().optional(),
    age_years: z.number().nullable().optional(),
    volPerTree_m3: z.number().nullable().optional(),
    treeCount: z.number().nullable().optional(),
  })).optional(),
  apvSortVolumesPerSpecies: z.record(z.object({
    ...
    M1: z.number().nullable().optional(),
    M2: z.number().nullable().optional(),
    M3: z.number().nullable().optional(),
    LS: z.number().nullable().optional(),
    firewood: z.number().nullable().optional(),
    bark: z.number().nullable().optional(),
    grossVolume: z.number().nullable().optional(),
  })).optional(),
  apvRottenTreesCount: z.number().nullable().optional(),
  apvRottenTreesVolume: z.number().nullable().optional(),
